	...
	<div class="p-6">
		<div class="grid grid-cols-3 gap-4 mb-6">
			<?php foreach ( $brands as $brand_key => $brand_name ) : ?>
				...
				// Build CSS classes for brand item
				$base_classes   = 'flex items-center gap-2 p-3 rounded-[20px] transition-all duration-200 focus:outline-none group';
				...
				$icon_classes = 'h-5 w-5 transition-colors duration-200 ' . ( $is_active ? 'text-[#e5462f]' : 'text-gray-600 group-hover:text-[#e5462f]' );
					...
					<div class="col-span-3">
						<div class="border-2 border-[#e6d4b8] rounded-[20px] overflow-hidden">
							...
							<a href="<?php echo esc_url( $brand_url ); ?>" class="<?php echo esc_attr( $css_classes ); ?> !rounded-none border-b-2 border-[#e6d4b8]" aria-label="Navigate to <?php echo esc_attr( $brand_name ); ?>" <?php echo $is_active ? 'aria-current="page"' : ''; ?>>
								...
								<span class="text-xs text-gray-500 group-hover:text-[#e5462f]">
